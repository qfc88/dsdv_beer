export default function define(runtime, observer) {
    ...
    const fileAttachments = new Map([["BeerConsumption_Cleaned_Main_2.csv",new URL("https://github.com/qfc88/dsdv_beer/blob/main/BeerConsumption_Cleaned_Main_2.csv",import.meta.url)]]);
